...
class Genre(models.Model):
    ...
    is_fiction = models.BooleanField(default=True, help_text="Czy gatunke jest fikcyjny (Literatura piękna).")
...
class Author(models.Model):
    """Model reprezentujący autora ksiązki"""
...
class Book(models.Model):
    """Model reprezentujący ksiązkę w bibliotece"""
